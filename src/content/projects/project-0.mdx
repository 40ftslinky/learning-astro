...
head: 'Markdown elements demo post'
description: 'This is the an MDX post of my new Astro projects.'
author: 'Astro Learner'
pubDate: 2024-01-12
image:
    url: '/src/assets/project-3/lug+Carrie_webmock.jpg'
    alt: 'Grey.'
    width: '100%'
    height: '100%'
video: 
...
import project01 from '/src/assets/project-1/Editorial-Mockup_00.jpg';

import video01 from '/video/studio-dumbar-demo-typography.mp4';

Local image stored in src/assets/
<Image src={project01} alt="project01 image" />

<video width="100%" height="100%" 
  src="/video/studio-dumbar-demo-typography.mp4" 
  type="video/mp4"
  autoplay
  loop
  >
